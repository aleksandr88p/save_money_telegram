...
def get_russian_keyboard():
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🎙️ Отправить аудио", callback_data="send_audio")],
        [InlineKeyboardButton(text="📊 Запросить расходы", callback_data="query_expenses")],
...
def get_english_keyboard():
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🎙️ Send Audio", callback_data="send_audio")],
        [InlineKeyboardButton(text="📊 Query Expenses", callback_data="query_expenses")],
